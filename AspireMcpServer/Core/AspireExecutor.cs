...
namespace AspireMcpServer.Core;

/// <summary>
/// Provides utilities for executing .NET Aspire CLI commands
/// </summary>
public static class AspireExecutor
{
    /// <summary>
    /// Executes an aspire command and returns the result
    /// </summary>
    /// <param name="arguments">The aspire command arguments</param>
    ...
    /// <summary>
    /// Validates that the aspire CLI is available
    /// </summary>
    /// <returns>True if aspire CLI is available</returns>
